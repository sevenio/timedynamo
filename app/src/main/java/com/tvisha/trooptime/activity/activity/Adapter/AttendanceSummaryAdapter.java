...
public class AttendanceSummaryAdapter extends RecyclerView.Adapter<AttendanceSummaryAdapter.ViewHolder> {
    ...
    public AttendanceSummaryAdapter(Context context, List<EmployeeData> items, AttendanceFragment attendanceFragment) {
        this.items = items;
    ...
    @Override
    public AttendanceSummaryAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, final int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.attendace_summary_row_design, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final AttendanceSummaryAdapter.ViewHolder viewHolder, final int position) {
            ...
            if (items != null && items.size() > 0 && position < items.size()) {
                ...
                if (model != null) {
                    ...
                    if (!checkin.trim().equals("N/A")) {
                        ...
                        viewHolder.check_in_hours_tv.setText("N/A");
                    ...
                    if (!checkout.trim().equals("N/A")) {
                        ...
                        viewHolder.check_out_hours_tv.setText("N/A");
                    ...
                    if (!model.getCheck_in().contains("0000-00-00") && !model.getCheck_out().contains("0000-00-00")) {
                        ...
                        viewHolder.no_work_hours_tv.setVisibility(View.VISIBLE);
                    }
                    //attendanceId
